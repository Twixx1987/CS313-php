		...
		<div id="featuredProducts" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner bg-light">
				<div class="carousel-item active">
					...
					<a href="coffins.php">
						<img class="carouselImage" src="https://static.turbosquid.com/Preview/2014/07/11__22_47_27/Coffin2_2.jpgb9394da4-5103-4409-9c3b-07fbc28eeaf1Original.jpg" alt="Deluxe Pine Coffin">
					</a>
				</div>
				<div class="carousel-item">
					...
					<a href="computers.php">
						<img class="carouselImage" src="http://www.device.pl/content/images/thumbs/0002415_dell-optiplex-380-pentium-dc.jpeg" alt="Deluxe Computer">
					</a>
				</div>
				<div class="carousel-item">
					<div class="subtext">
					...
					<a href="tools.php">
						<img class="carouselImage" src="http://woodworking-kids.com/content/2010/09/51EGTV0Xb2L._SL500_AA300_1.jpg" alt="Deluxe Children's Toolset">
					</a>
				</div>
			</div>
