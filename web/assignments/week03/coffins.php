		...
		<form id="coffins" action="coffins.php" method="post">
			<div class="row">
				...
				<div class="col-md">
					...
					> at $1,500 each<br/>
					<input type="submit" role="button" id="pineSubmit" name="pineSubmit" class="btnAddCart btn btn-secondary" value="Add to Cart">
				</div>
			</div>
			<div class="row">
				<div class="col-sm mx-auto">
				...
				<div class="col-md">
					...
					> at $2,500 each<br/>
					<input type="submit" role="button" id="mahoganySubmit" name="mahoganySubmit" class="btnAddCart btn btn-secondary" value="Add to Cart">
				</div>
			</div>
			<div class="row">
				<div class="col-sm mx-auto">
				...
				<div class="col-md">
					...
					> at $3,500 each<br/>
					<input type="submit" role="button" id="cedarSubmit" name="cedarSubmit" class="btnAddCart btn btn-secondary" value="Add to Cart">
				</div>
			</div>
			<div class="row">
				<div class="col-sm mx-auto">
				...
				<div class="col-md">
					...
					> at $4,500 each<br/>
					<input type="submit" role="button" id="beachSubmit" name="beachSubmit" class="btnAddCart btn btn-secondary" value="Add to Cart">
				</div>
			</div>
		</form>
	</div>
