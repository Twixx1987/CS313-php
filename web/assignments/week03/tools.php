		...
		<form id="tools" action="tools.php" method="post">
			<div class="row">
				...
				<div class="col-md">
					...
					> at $40 each<br/>
					<input type="submit" role="button" id="blueSubmit" name="blueSubmit" class="btnAddCart btn btn-secondary" value="Add to Cart">
				</div>
			</div>
			<div class="row">
				<div class="col-sm mx-auto">
				...
				<div class="col-md">
					...
					> at $40 each<br/>
					<input type="submit" role="button" id="pinkSubmit" name="pinkSubmit" class="btnAddCart btn btn-secondary" value="Add to Cart">
				</div>
			</div>
		</form>
	</div>
